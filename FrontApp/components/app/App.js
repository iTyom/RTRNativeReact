...
//       fetch('https://rtrnativereact.firebaseio.com/contacts.json', {
//         method: 'POST',
//         headers: {
...
//                   </Left>
//                   <Body>
//                     <TouchableOpacity successonPress={() => this._togglePostCard()}>
...
//                   <Textarea rowSpan={5} borderedplaceholder="Type your message" onChangeText={(msg) => this.setState({ msg })} ref={'msgClear'} />
//                 </Form>
//                 <CardItem>
//                   <Left>
//                   </Left>
